...
import 'package:crafty_bay/view/payment/pages/payment_webView_screen.dart';
...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.find<CreateInvoiceViewModel>().createInvoice();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar,
      body: GetBuilder<CreateInvoiceViewModel>(builder: (controller) {
