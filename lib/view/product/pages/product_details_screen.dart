...
import 'package:crafty_bay/view/review/pages/reviews_screen.dart';
import 'package:crafty_bay/reusable/loading/center_circular_progress_indicator.dart';
import 'package:crafty_bay/view/product/widgets/product_image_carousel.dart';
import 'package:crafty_bay/view/product/widgets/size_selector.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:item_count_number_button/item_count_number_button.dart';

import '../../../view_model/wish_list/add_to_wishlist_view_model.dart';
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.find<ProductDetailsViewModel>().getProductDetails(widget.productId);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<ProductDetailsViewModel>(builder: (controller) {
  ...
  Row reviewAndRatingRow(int rating) {
    return Row(
      children: [
        ...
        InkWell(
          onTap: () async {
            bool response = await Get.find<AddToWishListViewModel>()
            ...
            if (response) {
              ...
              Get.showSnackbar(GetSnackBar(
                ...
                message: Get.find<AddToWishListViewModel>().errorMessage,
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Text(
                '\$${Get.find<ProductDetailsViewModel>().productDetails.product?.price ?? 0}',
          ...
          SizedBox(
            width: 120,
            child: GetBuilder<AddToCartViewModel>(builder: (controller) {
              return Visibility(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    if (_selectedColor != null && _selectedSize != null) {
                      if (Get.find<AuthViewModel>().isTokenNotNull) {
